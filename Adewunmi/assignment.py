...
if __name__ == '__main__':
    Assignment.is_grade(95)
    Assignment.box_of(32)
    Assignment.bacteria_start_with(16)
    Assignment.hourly_wage(8, 5, 12)
    Assignment.heart_rate()
    Assignment.turing_test()
    Assignment.flu()
    Assignment.equilateral_triangle(5, 7, 9)
    Assignment.fibonacci(7)
